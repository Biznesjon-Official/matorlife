        ...
        <div className="card-gradient p-4 sm:p-6 animate-slide-up">
          ...
          {(earningsData as any)?.earnings?.apprenticeList && (earningsData as any).earnings.apprenticeList.length > 0 && (
            <div className="space-y-3">
              <h4 className="text-lg font-bold text-gray-900 mb-4">{t("Shogirdlar daromadlari", language)}</h4>
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mb-4 pb-4 border-b border-gray-200">
                          ...
                          <div className="text-xs text-gray-500 space-y-1">
                            ...
                            {apprentice.savedEarnings > 0 && (
                              <div className="text-blue-600">
                                {t('Asosiy daromad:', language)} {formatCurrency(apprentice.savedEarnings)}
                              </div>
                            )}
                            {apprentice.taskEarnings > 0 && (
                              <div className="text-green-600">
                                {t('Vazifalardan:', language)} {formatCurrency(apprentice.taskEarnings)}
                              </div>
                            )}
                          </div>
                        </div>
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-xs text-gray-500">{t('Jami daromad', language)}</div>
                      </div>
                    </div>
                            ...
                            <div className="flex-1">
                              ...
                              {task.approvedAt && (
                                <div className="text-xs text-gray-500 mt-1">
                                  {t('Tasdiqlangan:', language)} {format(new Date(task.approvedAt), 'dd.MM.yyyy HH:mm')}
                                </div>
                              )}
                              {task.percentage && task.totalPayment && (
                                <div className="text-xs text-blue-600 mt-1">
                                  {t('Umumiy:', language)} {formatCurrency(task.totalPayment)} • {t('Foiz:', language)} {task.percentage}%
                                </div>
                              )}
                            </div>
                            <div className="text-right ml-4">
                              ...
                              {task.percentage && (
                                <div className="text-xs text-gray-500">
                                  ({task.percentage}% {t('ulush', language)})
                                </div>
                              )}
                            </div>
                          </div>
