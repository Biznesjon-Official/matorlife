                ...
                <div className="pt-8 sm:pt-10 px-4 sm:px-5 pb-4 sm:pb-5">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <button 
                      ...
                      className="flex items-center justify-center p-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-200 shadow-md hover:shadow-lg"
                    ...
                    <button 
                      ...
                      className="flex items-center justify-center p-2.5 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200 transition-all duration-200"
                    ...
                    <button 
                      ...
                      className="flex items-center justify-center p-2.5 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-all duration-200"
