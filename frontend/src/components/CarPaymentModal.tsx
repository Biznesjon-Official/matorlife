...
const CarPaymentModal: React.FC<CarPaymentModalProps> = ({ isOpen, onClose, car, onSuccess }) => {
      ...
      <div className="relative bg-white rounded-xl sm:rounded-2xl shadow-2xl max-w-2xl w-full max-h-[95vh] sm:max-h-[90vh] overflow-y-auto mx-2 sm:mx-0 my-4 sm:my-0">
        ...
        <div className="bg-gradient-to-r from-green-500 to-emerald-600 px-6 py-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">{t("Xizmat to'lovi", language)}</h2>
...
export default CarPaymentModal;
